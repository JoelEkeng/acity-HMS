...
// Variant mapping to base colors
const variants: Record<BadgeVariant, keyof typeof colors> = {
  success: 'green',
  warning: 'amber',
  info: 'blue',
  destructive: 'red',
...
type BadgeVariant = 'success' | 'warning' | 'info' | 'destructive' | 'secondary' | 'default'
...
export function Badge({
  ...
  const actualColor = color ?? variants[variant]
